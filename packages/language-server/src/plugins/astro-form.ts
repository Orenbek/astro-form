    ...
    create(context): LanguageServicePluginInstance {
      return {
        provideCompletionItems(document, position, completionContext, token) {
          ...
          if (!(virtualCode instanceof AstroFormVirtualCode)) return
...
function getFrontmatterCompletion(file: AstroFormVirtualCode, document: TextDocument, position: Position) {
